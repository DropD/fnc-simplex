...
\mypar{Linear Optimization Problems} \rtodo{put the Max c'x Subject to \dots formula and explain}
...
The problem size was varied from 10 up to 1000, 2000 or even 4000 where relevant for out-of-cache comparison.
