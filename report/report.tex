...
Profiling with \dtodo{insert tool here} shows that \dtodo{$??\, \%$} of the
runtime is spent in the {\tt base\_exchange} function. For this reason, subsequent optimizations focused
on the {\tt base\_exchange} step.
