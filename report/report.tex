...
All experiments were conducted on a Core i5-3360M (Ivy Bridge), running GNU/Linux. 
\dtodo{cpu specs table}
...
The problem size was varied from 10 to 1000 for most experiments. For profiling also larger problems were used. \dtodo{what problem sizes did you actually use?}
...
As shown in Fig.~\ref{res_cachecontrol}, nontemporal assignment showed a mostly positive but miniscule effect on the swapping implementations,
