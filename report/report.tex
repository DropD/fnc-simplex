...
\begin{itemize}
    ...
    \item{Gurobi \cite{gurobi}, a commercial grade package which claims to be the fastest available solution when taking into account multi-threading.}
    \item{SoPlex}
\end{itemize}
\mytodo{cite original danzig paper, handouts from opti, papers of the other implementations.}
