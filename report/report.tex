...
One particularly interesting result is that while AVX intrinsics do not noticeably improve performance, they even degrade the efficiency if we turn on autovectorisation (Fig).
