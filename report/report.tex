...
Further annotated analysis revealed stalls at the memory access functions, can be alleviated via ILP where unit stride access was applicable.
...
a C99 one dimensional contiguous array allocated and aligned using { \verb _mm_malloc } from
the intel intrinsics headers.

All subsequent optimizations were based on this implementation.

\dtodo{
\mypar{Nontemporal Assignments}
}
